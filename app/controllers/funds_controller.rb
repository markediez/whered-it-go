class FundsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @fund.save
        format.html { redirect_to @fund, notice: 'User was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @fund.update(fund_params)
        format.html { redirect_to @fund, notice: 'User was successfully updated.' }
  ...
  private
    ...
    def fund_params
      params.require(:fund).permit(:amount, :amount_set_at)
    end
end
