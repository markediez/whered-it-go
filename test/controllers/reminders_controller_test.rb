...
class RemindersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder" do
    assert_difference('Reminder.count') do
      post reminders_url, params: { reminder: { archived: @reminder.archived, frequency: @reminder.frequency, name: @reminder.name, status: @reminder.status, url: @reminder.url } }
    end
  ...
  test "should update reminder" do
    patch reminder_url(@reminder), params: { reminder: { archived: @reminder.archived, frequency: @reminder.frequency, name: @reminder.name, status: @reminder.status, url: @reminder.url } }
