...
class ReminderTemplatesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reminder_template" do
    assert_difference('ReminderTemplate.count') do
      post reminder_templates_url, params: { reminder_template: { frequency: @reminder_template.frequency, name: @reminder_template.name, triggered_at: @reminder_template.triggered_at } }
    end
  ...
  test "should update reminder_template" do
    patch reminder_template_url(@reminder_template), params: { reminder_template: { frequency: @reminder_template.frequency, name: @reminder_template.name, triggered_at: @reminder_template.triggered_at } }
